                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Idea Details</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="all-complaint.php">Idea Details</a></li>
...
?>                                  
                                        <tr>
                                            <td><b>Idea Number</b></td>
                                            <td><?php echo htmlentities($row['complaintNumber']);?></td>
                                            <td><b>Poster Name</b></td>
...
<tr>
                                            ...
                                            <td ><b>Topic of Idea</b></td>
                                            <td colspan="3"> <?php echo htmlentities($row['noc']);?></td>
                                            
                                        </tr>
<tr>
                                            <td><b>Idea Description </b></td>
