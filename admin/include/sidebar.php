...
?>	
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-menu-caption">
						<label>User Ideas</label>
					</li>


					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Manage Ideas</span></a>
						<ul class="pcoded-submenu">
							<li>
	<a href="all-complaint.php">All Ideas</a></li>
							<li>
	<a href="notprocess-complaint.php">Not Process Yet</a></li>
							<li>
								<a href="inprocess-complaint.php">In Process</a></li>
							
							<li><a href="closed-complaint.php">Closed Ideas</a></li>
					...
					<li class="nav-item">
					    <a href="between-date-complaintreport.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">Ideas Report</span></a>
					</li>
					<li class="nav-item pcoded-menu-caption">
						<label>Search</label>
					</li>
					...
					<li class="nav-item">
					    <a href="complaint-search.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-search"></i></span><span class="pcoded-mtext">Search Idea</span></a>
					</li>
