...
<head>
    <title>Smart Ideas Platform || Dashboard</title>
            ...
            <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card bg-primary">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php $query4=mysqli_query($con,"select id from state");
$totstate=mysqli_num_rows($query4);
?>
                            <h4><?php echo $totstate;?></h4>
                            <a href="state.php"><h6>Total State</h6></a>
                        </div>
                    </div>
                </div>
                <!-- widget-success-card end -->
...
?>
                            ...
                            <a href="all-complaint.php"><h6>Total Ideas</h6></a>
                        </div>
                    </div>
                </div>
                <!-- widget-success-card end -->
...
?>
                            ...
                            <a href="notprocess-complaint.php"><h6>Pending Ideas</h6></a>
                        </div>
                    </div>
                </div>
                <!-- widget-success-card end -->
...
?>
                            ...
                            <a href="inprocess-complaint.php"><h6>Inprocess Ideas</h6></a>
                        </div>
                    </div>
                </div>
...
?>
                            ...
                            <a href="closed-complaint.php"><h6>Closed Ideas</h6></a>
                        </div>
                    </div>
                </div>
