    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="index.html" class="navbar-brand mx-auto mx-lg-0">Goxlog.com</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                ...
                                <h3 class="mb-4">Do you have a good business idea & you're in need of cash or business partner?</h3>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/Goxlog Global final_page-0001.jpg" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-center align-items-center mb-4">
                                    <h3 class="text-white me-4 mb-0">Who we are</h3>
                                </div>

                                <p>Welcome to Goxlog, the global marketplace for business ideas! At Goxlog, we believe that every great business starts with a bold idea, and we’re here to connect entrepreneurs, innovators, and business enthusiasts from around the world. </p> 
                                <p>Our platform is designed to empower individuals to share their business ideas, seek funding, or find the perfect partnership to bring their vision to life. </p>
                                <p>Whether you’re an aspiring entrepreneur with a groundbreaking concept or an established business professional looking to collaborate, Goxlog provides a dynamic space to showcase your ideas, gain visibility, and connect with like-minded individuals. Users can explore a wide range of ideas, show their support by liking posts, and even discover opportunities to sponsor or fund the most promising ventures. </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-8 col-12">
                                <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                                    ...
                                    <h3 class="text-white ms-4 mb-0">Contact us</h3>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <strong class="site-footer-title d-block mt-4 mb-3">Reach Out</strong>

                                    <p class="mb-0">In case of any enquiries, feel free to call or send an email</p>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="copyright-text-wrap">
                            <p class="mb-0">
                                <span class="copyright-text">Copyright © 2025 <a href="#">Goxlog global</a> Company. All rights reserved.</span>
                                Design: 
                                <a rel="sponsored" href="https://templatemo.com" target="_blank">Pinelink solutions</a>
                            </p>
                        </div>
                    </div>
