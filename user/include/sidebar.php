...
?>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="register-complaint.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Post Idea</span></a>
					</li>
					<li class="nav-item">
					    <a href="complaint-history.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">All Posted Ideas</span></a>
					</li>
					<li class="nav-item">
					    <a href="complaint-history.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">Ideas History</span></a>
					</li>
