...
// Ensure the 'contact' information is stored in the session before
if(isset($_SESSION['contact'])){
        $contact = $_SESSION['contact']; // Retrieve contact from session
} else {
    $contact = ''; // Default to an empty string if session does not have contact
}
...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,complaintType,state,noc,complaintDetails,contact) values('$uid','$category','$complaintype','$state','$noc','$complaintdetials','$contact')");
...
$complainno=$cmpn;
echo '<script> alert("Your new idea has been successfully filled and your idea no is  "+"'.$complainno.'")</script>';
//}
}
...
<head>
    <title>smartidea.io||Register Idea</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Register Idea</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="register-complaint.php">Register Idea</a></li>
...
?>
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">Seeking for?</label>
...
?>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">Topic of Idea</label>
                                       <input type="text" name="noc" required="required" value="" required="" class="form-control">
